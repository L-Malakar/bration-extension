...
The Rust core lives in [`bration-extinction-core/`](./bration-extinction-core) and is compiled automatically via GitHub Actions on every push — see [`.github/workflows/build-wasm.yml`](./.github/workflows/build-wasm.yml).

## 🛠️ Building from source

```bash
# Requires Rust + wasm-pack
cd bration-extinction-core
...
- **Firefox**: install from [addons.mozilla.org](https://addons.mozilla.org/en-US/firefox/addon/bration-extinction/)
